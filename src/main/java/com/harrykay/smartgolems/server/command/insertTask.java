...
public class insertTask {
    ...
    public static final String SUB_COMMAND = "insert-task";
        ...
        return Commands.literal(SUB_COMMAND)
                ...
                .then(Commands.literal(supportedTasks.name())
                        ...
                        .then(Commands.argument(GOLEM_NAME, StringArgumentType.string())
                                .then(Commands.argument(PRIORITY, IntegerArgumentType.integer(0, SmartGolemEntity.maxTasks))
                                        .executes(ctx -> {
                                                    ...
                                                    Integer priority = IntegerArgumentType.getInteger(ctx, PRIORITY);
                                                    golemEntity.insertGoal(priority, supportedTasks);
                                                    return 0;
                                                }
                                        ))));
    }
